...
const Contact = () => {
  return (
    <section className="bg-white text-black py-12 lg:mt-30 mt-10">
      <div className=" mx-auto px-4 lg:px-24">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
          ...
          <div className="text-center lg:text-left mb-8 lg:mb-0">
            ...
            <FaPhone className="text-black text-4xl mb-2" />
            </div>
            <h3 className="text-2xl font-bold">Call Us</h3>
            <p className='text-black text-[12px]'>If you prefer to speak directly, you can call us at <strong>+1 (555) 123-4567</strong>. We're available for calls during business hours.</p>
          </div>
          <div className="text-center lg:text-left">
            <div className='flex items-center justify-center lg:justify-start'>
            <FaMapMarkerAlt className="text-black text-4xl mb-2" />
            </div>
            <h3 className="text-2xl font-bold">Visit Us</h3>
            <p className='text-black text-[12px]'>If you're in the area, feel free to visit us at our studio located at <strong>Shibuya 1-1-1, Tokyo, Japan</strong>. We welcome fans and collaborators alike!</p>
          </div>
        </div>
        <div className="mt-8">
          <iframe
